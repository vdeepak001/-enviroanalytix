...
@section('content')
  @include('admin.partials.breadcrumb', ['pageTitle' => 'Dashboard'])
...
<div class="grid grid-cols-12 gap-4 md:gap-6">
  <div class="col-span-12 space-y-6 xl:col-span-12">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 md:gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            ...
            <div class="mt-5 flex items-end justify-between">
                ...
                <!-- Optional percentage badge here -->
            </div>
        </div>
        <!-- Metric Item End -->
    ...
    <!-- Chart One Start -->
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6 mt-6">
        ...
        <div class="max-w-full overflow-x-auto custom-scrollbar">
            <div id="chartOne" class="-ml-5 h-[350px] min-w-[650px] pl-2 xl:min-w-full"></div>
        </div>
    </div>
    <!-- Chart One End -->
